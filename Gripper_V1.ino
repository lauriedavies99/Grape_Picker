...
void setup() {
  ...
  //Angle Conversion
  GripperClosed = (GripperClosed + 65) * 11.377;
  GripperOpen = (GripperOpen + 55) * 11.377;
  CutterClosed = (CutterClosed + 65) * 11.377;
  CutterOpen = (CutterOpen+ 55) * 11.377; 
